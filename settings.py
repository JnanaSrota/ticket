...
if DEBUG:
    DATABASES = {
        'default': {
            ...
            'PASSWORD': config('DB_PASSWORD', default='TravelPass123!'),
    ...
    # Production database (can use DATABASE_URL for services like Heroku)
    DATABASES = {
...
if DEBUG:
    ...
    DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@travelbooking.com')